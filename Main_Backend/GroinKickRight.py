...
cap = cv2.VideoCapture('Videos\GroinKickRight.mp4')
        ...
        if not final_pose_detected:
            ...
            if not cooldown_active:
                ...
                if not initial_stance(lmlist):
                    ...
                    angles = process_pose(lmlist, [12, 14, 16], [12, 24, 26], [26, 28, 32], [12, 11, 23], [11, 23, 25], [23, 25, 27], [25, 27, 31])
                    ...
                    interpolated_angles = [int(np.interp(angle, src, dst)) for angle, src, dst in zip(angles,
                                                                                                          [[75, 55], [190, 115],
                                                                                                           [110, 92], [270, 275], [140, 165], [218, 219], [120, 90]],
                                                                                                          [[0, 100], [0, 100],
